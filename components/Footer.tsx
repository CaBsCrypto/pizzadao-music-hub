...
export default function Footer() {
  ...
  return (
    <footer className="bg-pizza-dark-bg border-t border-pizza-dark-border px-8 py-12 text-center">
      ...
      <p className="text-[0.85rem] max-w-[380px] mx-auto mb-8 font-body leading-relaxed tracking-[0.03em]" style={{ color: 'rgba(200,233,255,0.55)' }}>
        {T.description}
      </p>
      <div className="flex justify-center gap-8 flex-wrap mb-8">
        {T.links.map(({ label, href }) => (
          <a
            ...
            style={{ color: 'rgba(200,233,255,0.45)' }}
          >
            {label}
          </a>
        ))}
      ...
      <div className="flex flex-col items-center gap-2">
        <a
          ...
          style={{ border: '1px solid rgba(74,127,193,0.3)', color: 'rgba(200,233,255,0.4)' }}
        >
          <span className="text-[0.85rem]">🄯</span> CC0 · No Rights Reserved
        </a>
        <p className="text-[0.65rem] font-body tracking-[0.05em] uppercase" style={{ color: 'rgba(200,233,255,0.25)' }}>
          {T.copy}
        </p>
      </div>
    </footer>
