      ...
      >
        ...
        <div className="relative">
          ...
          <div
            ...
            style={{ background: 'linear-gradient(to right, #FEFCF8, transparent)' }}
          />
          {/* Right fade */}
          <div
            className="absolute right-0 top-0 bottom-0 w-12 z-10 pointer-events-none"
            style={{ background: 'linear-gradient(to left, #FEFCF8, transparent)' }}
          />
          ...
          >
            ...
            <div
              ...
              style={{ width: '200px', scrollSnapAlign: 'start', background: '#FEFCF8' }}
